...
`images.icon` prefers mapped game or official site asset URLs when the item can be matched. If no asset is mapped yet, it falls back to the Zenless Zone Zero Wiki file redirect. `images.generatedIcon` remains available as a local fallback generated by this API.
